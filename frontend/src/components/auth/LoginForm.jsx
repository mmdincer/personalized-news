          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid gap-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 px-4 min-h-[48px] inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none touch-manipulation"
              >
                {isLoading ? (
                  <>
                    <svg
